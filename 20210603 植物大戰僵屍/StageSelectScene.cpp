...
void StageSelectScene::Initialize() {
    ...
    //by me setting btn
    Engine::ImageButton* setbtn;
	setbtn = new Engine::ImageButton("win/dirt.png", "win/floor.png", halfW - 200, halfH * 7 / 4 - 50, 400, 100);
	setbtn->SetOnClickCallback(std::bind(&StageSelectScene::BackOnClick, this, 2));
	AddNewControlObject(setbtn);
