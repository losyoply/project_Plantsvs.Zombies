...
#include "LOG.hpp"
#include "../hackthon mini 2/KirbyTurret.hpp"
#include "../hackthon mini 2/taikoenemy.hpp"
...
void PlayScene::OnKeyDown(int keyCode) {
	...
	if (keyCode && keyCode!= ALLEGRO_KEY_TAB) {
		DebugMode = !DebugMode;
	}
	else {
...
void PlayScene::ConstructUI() {
    ...
    btn = new TurretButton("play/floor.png", "play/dirt.png",
    Engine::Sprite("play/kirby.png", 420, BlockSize*MapHeight, 0, 0, 0, 0), 410, 128*MapHeight, KirbyTurret::Price);
